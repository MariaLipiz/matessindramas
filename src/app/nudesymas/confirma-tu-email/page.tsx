    ...
    return (
      <main>
        ...
        <section className="section space-y-6 mb-12 text-base sm:text-xl font-normal mt-4">
          <p>
            Entiendo que eres un pervertido impaciente, pero antes debes ir a tu bandeja de entrada y confirmarme que este email que has metido 
            no es fake y que no eres un bot ni nada de eso. 
          </p>
          ...
          <p>
            De no hacerlo en ese tiempo, es muy probable que ya no puedas recibir material de bueno y que esta noche te despiertes a las 3:33
            de la mañana mientras Pedro Sanchez te observa desde una esquina de tu habitación. 
          </p>
          ...
          <ul className="list-disc pl-6 space-y-4">
            ...
            <li>
              Si esto no es, guárdame en la agenda de contactos → Nombre: María NUDES, email: maria@matessindramas.es y espera unos minutos.
            </li>

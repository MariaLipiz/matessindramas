  ...
  return (
    ...
    <section className="section space-y-6 text-lg">
      ...
      <p>
        ...
        mal hechos con colores? ¿Estudias 20 minutos y descansas 5? ¿Te ha funcionado? 
      </p>
      <p>
        Me importa en cero y nada si en bachillerato sacabas notazas y te creías 
      ...
      <p>
        Y llenado cuadernos, blocks de notas y mi propio One Drive tomando notas. He tomado notas como una desgraciada. 
      ...
      <ol className="list-decimal pl-6">
        ...
        <li>Un breve cuestionario que deberías rellenar después de cada rato de estudio. </li>
      ...
      <h2 className=" mt-14 text-2xl font-bold text-black tracking-tighter sm:text-3xl lg:text-4xl xl:text-5xl">Mi método contiene 
        ...
        <li>Tutorías semanales online de seguimiento donde te diré si vas bien, si vas mal, 
            o si vas de culo, y te iré explicando todos los puntos. </li>
        <li>Soporte ilimitado durante todo el cuatri. Podrás escribirme por WhatsApp, email o 
      ...
      <p>
        ...
        este cuatrimestre que te estén costando sangre, sudor y lágrimas - salvo estadística, modelización y analisis 
      ...
      <p>
        ...
        menos meses. Es más, con el paso del tiempo subirá, pero bajar, jamás.
      </p>
      ...
      <p>
        ...
        Pago fraccionado en 2 cargos de 625€.
      ...
      <p>
        Durante los meses que estemos juntos, te enseñaré todas las técnicas que 
        apliqué para conseguir que un alumno del grado en matemáticas aprobase doce asignaturas –y no de las 
        fáciles- en un curso.
      </p>
      <p>
      ...
      <p>
        El método será un acompañamiento intensivo con cuatro meses de duración -o menos- donde te guiaré en las 
        asignaturas de matemáticas que tengas ese cuatri para asegurar 
        tu aprobado y que aprendas a estudiar.
      </p>
      <p>
        Todas las semanas haremos tutorías de seguimiento, ejercicios nuevos y nuevos apartados para que 
      ...
      <p>
        ...
        tu respuesta, aunque yo no ayudo con estadística, modelización y analisis numérico.
      </p>
      <p>
      ...
      <p>
        El precio del método es de 1250€ y nunca bajará. 
      ...
      <p>
        No. Si te apuntas dos meses el precio será 1250€, 

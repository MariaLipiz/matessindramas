import MatesNewsletterForm from "@/components/newsletter/MatesNewsletterForm";
...
export default function Home() {
    return (
      ...
      <section className="section  space-y-6">
        <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl lg:text-6xl"> ¿La carrera de&nbsp;

        <span className="bg-[#b0e4fc]">mates</span> te trae por la calle de la amargura?
        </h1>
      ...
      <section className="section space-y-6 mb-12 text-base sm:text-xl  font-normal mt-4">
        <p>
        Tus apuntes son un cacao y suenan a chino.
        </p>
        ...
        <p>
        Y no encuentras libro ni video de Youtube que te salve. 
        </p>
        <p className="mt-16">
        ...
        <p className="mb-12">
        <span className="font-semibold">Día que estás fuera, consejo que te pierdes.</span>
        </p>
        <MatesNewsletterForm />

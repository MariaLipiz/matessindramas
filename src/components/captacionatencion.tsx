      ...
      <section className="section flex flex-col space-y-8 text-sm sm:text-base font-medium">
        ...
        <div className="flex flex-col lg:flex-row gap-6 justify-center">
          <div className="rounded-2xl border-2 border-transparent p-4 transition-all duration-300 hover:border-[var(--neon-lime)]/40  bg-[var(--neon-lime)]/20">
            <h3>Tu profe lee diapositivas sin sentido en clase o llena la pizarra de demostraciones y <span className="font-bold">no entiendes ni papa</span></h3>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 justify-center">
          <div className=" rounded-2xl border-2 border-transparent hover:border-[var(--neon-purple)]/40 transition-all duration-300 p-4 bg-[var(--neon-purple)]/20">
            <h3>Has estado con muchos profesores particulares que te han vendido la moto y <span className="font-bold"> no te han ayudado</span></h3>
          </div>
